...
/**
 * Handles: VgSystemCall("components.MyGUI", "setOnKeyReleased", instance, callback)
 */
public class GUIKeyReleaseHandler extends BaseHandler {

    @Override
    public boolean matches(String className, String methodName, List<Object> args) {
        return is(className, methodName,
                "components.MyGUI", "setOnKeyReleased", args, 2);
    }
    ...
    public Object handle(String className, String methodName, List<Object> args) throws Exception {
        ...
        Method method = Class.forName(className).getMethod("setOnKeyReleased", KeyListener.class);

...
public class vg_langParser extends Parser {
	...
	public static final int
		...
		MULTI_LINE_COMMENT=46, IDENTIFIER=47, TRUE=48, FALSE=49, INT=50, DOUBLE=51, 
		STRING_LITERAL=52, WS=53;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'throw'", null, null, null, "'true'", "'false'"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8993674418185762L) != 0)) {
				{
				{
				setState(106);
				statement();
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8866543379284992L) != 0)) {
				{
				setState(193);
				expression();
				}

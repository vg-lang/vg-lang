...
public class vg_langLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "SINGLE_LINE_COMMENT", "MULTI_LINE_COMMENT", "IDENTIFIER", "TRUE", 
			"FALSE", "INT", "DOUBLE", "STRING_LITERAL", "ESC_SEQ", "UNICODE_ESC", 
			"HEX_DIGIT", "WS"
		};
	}
	...
	public vg_langLexer(CharStream input) {
		super(input);
